...
namespace YunPian.Services {
    public interface IVoiceService {
        ...
        /// <param name="mobile">接收的手机号、固话（需加区号） 13140000001 01088880000</param>
        /// <returns></returns>
        Task<Result<VoiceSend>> TplNotifySendAsync (string tpl_id, string tpl_value, string mobile);
        ...
        /// <returns></returns>
        Task<Result<List<VoiceStatus>>> PullVoiceStatusAsync (int type, int page_index, int page_size);
    }
}